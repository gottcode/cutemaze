...
!define ABOUTURL "http://gottcode.org/cutemaze/"
...
!define MUI_ICON "..\icons\cutemaze.ico"
!define MUI_UNICON "..\icons\cutemaze.ico"
...
!define MUI_FINISHPAGE_RUN "$INSTDIR\CuteMaze.exe"
...
Section "install"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$\"$INSTDIR\CuteMaze.exe$\""
	...
	CreateShortCut "$SMPROGRAMS\$StartMenuFolder\${APPNAME}.lnk" "$INSTDIR\CuteMaze.exe"
