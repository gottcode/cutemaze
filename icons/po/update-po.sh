...
intltool-extract --quiet --type=gettext/ini cutemaze.desktop.in

rm -f cutemaze.appdata.xml.in.h
...
intltool-extract --quiet --type=gettext/xml cutemaze.appdata.xml.in
